...
This repository is the implementation of the paper: [**Alignment-Enhanced Decoding: Defending via Token-Level Adaptive Refining of Probability Distributions**](https://openreview.net/forum?id=i3cJiZXE8K&referrer=%5Bthe%20profile%20of%20Quan%20Liu%5D(%2Fprofile%3Fid%3D~Quan_Liu5). In this paper, we present a novel defense that employs adaptive decoding to address the root causes of jailbreak issues.😊
